  ...
  return (
    <>
      ...
      <div className="bg-[url('/bg-green.png')] bg-no-repeat bg-fixed">
        <section className="mb-24 flex items-end justify-center animate-[appear2_1.3s_ease_1]">
        ...
        <section className="w-screen mt-10 flex flex-wrap p-4 justify-center animate-[appear4_2s_ease_1]">
          {recipes
            .filter(({ category }) =>
